...
2. The service worker is only enabled in the [production environment](#deployment),
...
4. By default, the generated service worker file will not intercept or cache any
